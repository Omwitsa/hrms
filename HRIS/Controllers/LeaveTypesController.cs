...
namespace HRIS.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Closed,Notes,IsCalenderDays,ExcludeHolidays,Personnel,CreatedDate,ModifiedDate")] LeaveType leaveType)
        {
            if (id != leaveType.Id)
            {
                return NotFound();
